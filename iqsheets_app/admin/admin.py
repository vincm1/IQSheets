...
from .views import MyAdminIndexView, AnalyticsView, TemplatesUploadView, SubscriptionsView, FineTuneModelView
...
def create_admin(db):
    ...
    admin.add_view(FineTuneModelView(name='FineTune GPT Model', endpoint='finetune'))
    return admin
